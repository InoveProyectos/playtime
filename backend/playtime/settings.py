"""
Django settings for playtime project.
...
SECRET_KEY = 'django-insecure-4pcdy9*+lz1onfgkcncf-opbvj4k6c4^j!m&obkj3$os6^8=o='
...
WSGI_APPLICATION = 'playtime.wsgi.application'
